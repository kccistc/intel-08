# 상공회의소 서울기술교육센터 인텔교육 8기

## Clone code 

```shell
git clone --recurse-submodules https://github.com/kccistc/intel-08.git
```
...
3. 과제 제출시 `인텔교육 8기 Github repository`에 `New Issue` 생성. 생성된 Issue에 하기 내용 포함되어야 함.
